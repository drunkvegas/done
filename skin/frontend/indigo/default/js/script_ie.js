 jQuery(document).ready(function() {
	...
	jQuery('.products-grid li.item .fancybox, .products-list li.item .fancybox').css({'right': '87%', 'opacity': 0});
	...
	if(navigator.userAgent.indexOf('IE 8')!=-1){
		...
		jQuery('.products-grid li.item:nth-child(-n+3)').css('padding-top:0;');
		jQuery('.cms-home li.item:nth-childnth-child(-n+4)').css('padding-top:0;');
    }
});  